...
@Singleton
public class RepoListViewModelFactory implements ViewModelProvider.Factory {

    private final Map<Class<? extends ViewModel>, Provider<ViewModel>> mCreators;

    @Inject
    public RepoListViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
